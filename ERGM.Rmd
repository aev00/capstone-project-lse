...
econlit_nodes <- read.csv('./data/econlit_nodes.csv')[, -1]
...
m5 <- ergm(net ~ edges + nodematch('female', diff = TRUE) + nodecov('experience')) 
summary(m5)
estoprob(coef(m5))
or(coef(m5))
# stargazer::stargazer(
...
```{r Results table}
setwd("C:/Users/valyo/Downloads/MASTERS/Capstone - MY498/capstone-2")
